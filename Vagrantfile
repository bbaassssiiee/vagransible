...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :centos6, autostart: true do |centos6_config|
    centos6_config.vm.box = "dockpack/centos6"  # to delete: 'vagrant destroy; box remove dockpack/centos6'
  ...
  config.vm.define :centos7, autostart: true do |centos7_config|
    centos7_config.vm.box = "chef/centos-7.1"
    centos7_config.vm.box_url = "https://atlas.hashicorp.com/chef/boxes/centos-7.1"
